...
function Navbar() {
    ...
    return (<header className={`navbar sticky top-0 inset-x-0 z-[100] flex items-center min-h-[3.5rem] w-full py-2 text-sm transition-all duration-300 bg-white dark:bg-black border-b ${isScrolled
